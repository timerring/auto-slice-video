...
def find_dense_periods_gpu(timestamps, window_size, top_n, max_overlap, step):
    ...
    calculate_window_density[blocks, threads_per_block](d_timestamps, window_size, step, d_results)
    ...
    if max_overlap is None:
        ...
        for idx, density in density_periods:
            ...
            for selected_idx in selected_indices:
                ...
                overlap = min(selected_start + window_size, current_start + window_size) - \
    ...
    densest_periods = [(int(start_time + i * step), 
                       int(results[i] * window_size)
